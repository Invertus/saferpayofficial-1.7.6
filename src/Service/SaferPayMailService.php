...
class SaferPayMailService
{
    ...
    private function getOrderConfData(Order $order, $orderStateId)
    {
        ...
        foreach ($order->getProducts() as $product) {
            ...
            $attribute = $this->getProductAttribute((int) $product['product_attribute_id'], $this->context->language->id);
            $product_var_tpl = [
    ...
    public function getProductAttribute($id = null, $idLang = null, $idShop = null)
    {
        ...
        throw new \Exception('Attribute class was not found');
    }
}
